...
<body>
    ...
    <div class="Content">
        ...
        <div id="Content_Title">ถอนวิชาเรียน</div>
                    ...
                    <div class="Table">
                        <table>
                            ...
                            <tr>
                                ...
                                <th data-labe="ถอนวิชาเรียน"><a href="Unsetprocess.php?classId=<?=$row1['class_ID']?>" style="text-decoration: none; color: rgb(255, 255, 255);">ถอนวิชาเรียน</a></th>
                            </tr>
                            <?php
                                }
                            ?>
                            ...
                            <tr>
                                <td colspan="3">รวมจำนวนหน่วยกิต</td>
